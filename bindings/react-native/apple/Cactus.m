...
@interface RCT_EXTERN_MODULE(Cactus, NSObject)
...
RCT_EXTERN_METHOD(complete:(NSString *)handle messagesJson:(NSString *)messagesJson optionsJson:(NSString * _Nullable)optionsJson toolsJson:(NSString * _Nullable)toolsJson pcmDataBase64:(NSString * _Nullable)pcmDataBase64 resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
...
RCT_EXTERN_METHOD(vad:(NSString *)handle audioPath:(NSString * _Nullable)audioPath optionsJson:(NSString * _Nullable)optionsJson pcmDataBase64:(NSString * _Nullable)pcmDataBase64 resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(diarize:(NSString *)handle audioPath:(NSString * _Nullable)audioPath optionsJson:(NSString * _Nullable)optionsJson pcmDataBase64:(NSString * _Nullable)pcmDataBase64 resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(embedSpeaker:(NSString *)handle audioPath:(NSString * _Nullable)audioPath optionsJson:(NSString * _Nullable)optionsJson pcmDataBase64:(NSString * _Nullable)pcmDataBase64 maskWeights:(NSArray<NSNumber *> * _Nullable)maskWeights resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
